...
const styles = StyleSheet.create({
  ...
  // New style for page break handling
  pageBreak: {
    marginTop: 20,
  },
});
...
const PDFContent = ({ 
  ...
  <Document>
    ...
    {/* =========================
        PAGE 2: Unit Parts Checklist Table ONLY
    ============================ */}
    <Page size="A4" style={styles.page}>
      <View style={styles.tableContainer}>
        {/* Table Title */}
    ...
    {/* =========================
        PAGE 3: Description Section + Service Outcome + Technician Info
    ============================ */}
    <Page size="A4" style={styles.page}>
      {/* =========================
          DESCRIPTION SECTION
      ...
      <View style={styles.serviceOutcomeSection}>
        ...
        <View style={styles.commentsRow}>
          <Text style={styles.bullet}>•</Text>
          <Text style={styles.commentsLabel}>Comments:</Text>
          <View style={[styles.underlineSmall, {width: '300px'}]}>
            <Text>{serviceDetails.outcomeComments || ""}</Text>
          </View>
        </View>
